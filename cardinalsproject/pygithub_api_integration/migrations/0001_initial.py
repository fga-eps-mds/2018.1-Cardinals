...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='issue',
            name='repository',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='pygithub_api_integration.Repository'),
        ),
        migrations.AddField(
            model_name='contributor',
            name='repository',
            field=models.ManyToManyField(to='pygithub_api_integration.Repository'),
        ),
        migrations.AddField(
            model_name='contributingweek',
            name='contributor',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='pygithub_api_integration.Contributor'),
        ),
        migrations.AddField(
            model_name='commit',
            name='author',
